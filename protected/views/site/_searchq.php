...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <fieldset><legend>&nbsp;Choose the year and the qualification from the dropdown lists below:&nbsp;</legend>
	 <table>
	  <tr>
	   <td width="550" rowspan="2">
		<div class="row">
                ...
                <div class="row">
		           <?php //echo CHtml::dropDownList('qualification', '', $model->qualificationOptions, array('id'=>'qualification','class'=>'dropdown1','style'=>'width:510px !important', 'size'=>1)); ?>
				   <?php echo $form->listBox($model,'qualification', $model->qualificationOptions, array('id'=>'qualification','name'=>'qualification','title'=>'Select course qualification','class'=>'dropdown1','style'=>'width:550px !important', 'size'=>1)); ?>
				</div>
          </td>
		  <td>&nbsp;</td>
         </tr>
...
<?php 			
	$this->widget('ext.tipsy.Tipsy', array(  
		...
		'items' => array(
				...
				array('id' => '#qualification','fallback' => 'Select course qualification','gravity' => 'e'),
			),  
		)
	);
?>
